...
// We manually add the GitHub icon since Lucide removed all brand logos
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-blue-200">
      ...
      <header className="max-w-4xl mx-auto pt-24 pb-16 px-6">
        ...
        <div className="flex gap-4">
          ...
          <a href="https://github.com/Donsonoluoch" target="_blank" rel="noreferrer"
      ...
      {/* Philosophy / Mindset Section (Tailored for Lishai Labs) */}
